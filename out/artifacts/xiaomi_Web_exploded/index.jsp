...
<div id="top">
    <div id="navtop">
        ...
        <div class="ntright">
            <a href="/ssm_xiaomi/login.jsp">登录</a> | <a href="/ssm_xiaomi/register.jsp">注册</a> | <a href="#">消息通知</a>  <div><a href="/ssm_xiaomi/shopcart.jsp">购物车 (0)</a></div>
        </div>
    </div>
</div>
<header>
    ...
    $(function() {
       ...
       function loadGoods(goodslist, container) {
           ...
           for(let i = 0; i < goodslist.length; i++) {
               ...
               let $a = $("<a>").attr("href", "/ssm_xiaomi/detail.jsp?gid=" + goodslist[i].id);
        ...
        $("#search button").click(function() {
            ...
            console.log($word);
            // 跳转页面
            window.location = "/ssm_xiaomi/goodslist.jsp?wd=" + $word;
            // 按钮存在在表单中的，所以点击按钮的时候需要阻止浏览器默认行为
       ...
       $("#bannel-type > ul").on("click", "li", function() {
           ...
           // 页面跳转
           window.location = "/ssm_xiaomi/goodslist2.jsp?level=1&goodsTypeId="+$goodsTypeId;
